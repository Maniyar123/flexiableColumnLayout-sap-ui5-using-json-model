		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Flexiable Column Layout",
									"targetURL": "#comfclfclproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comfclfclproject-display": {
								"semanticObject": "comfclfclproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.fcl.fclproject",
									"url": sap.ui.require.toUrl("com/fcl/fclproject")
								}
							}
						}
					}
